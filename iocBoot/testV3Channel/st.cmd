...
dbLoadRecords("db/dbScalar.db","name=uint01,type=ulong")
...
dbLoadRecords("db/dbScalar.db","name=uint02,type=ulong")
...
dbLoadRecords("db/dbScalar.db","name=uint03,type=ulong")
