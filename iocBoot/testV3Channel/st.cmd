...
dbLoadRecords("db/dbScalar.db","name=ubyte01,type=ubyte")
dbLoadRecords("db/dbScalar.db","name=ushort01,type=ushort")
dbLoadRecords("db/dbScalar.db","name=ulong01,type=ulong")
...
dbLoadRecords("db/dbScalar.db","name=ubyte02,type=ubyte")
dbLoadRecords("db/dbScalar.db","name=ushort02,type=ushort")
dbLoadRecords("db/dbScalar.db","name=ulong02,type=ulong")
...
dbLoadRecords("db/dbScalar.db","name=ubyte03,type=ubyte")
dbLoadRecords("db/dbScalar.db","name=ushort03,type=ushort")
dbLoadRecords("db/dbScalar.db","name=ulong03,type=ulong")
